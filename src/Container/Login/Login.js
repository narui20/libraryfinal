    ...
    onClickHandler=event=>{
       ...
       let val={
           ...
           password:this.state.password,
            ...
            axios.post("http://ec2-3-80-131-98.compute-1.amazonaws.com:8081/api/getUser/"+val.userName+"/"+val.password)
            .then(res=>{
                ...
                Axios.post("http://ec2-3-80-131-98.compute-1.amazonaws.com:8081/api/getAdmin/"+val.userName+"/"+val.password)
                .then(res=>{
                           if(res.data===""){
                               this.props.history.push("/")
